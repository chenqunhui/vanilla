...
public class DefaultResponseFuture implements ResponseFuture {
    ...
    public DefaultResponseFuture(Channel channel, Request request, long timeout) {
    ...
    public DefaultResponseFuture(Channel channel, Request request, ResponseCallback callback) {
        this.channel = channel;
        this.request = request;
        this.id = request.getId();
        this.timeout = channel.getUrl().getPositiveParameter(Constants.TIMEOUT_KEY, Constants.DEFAULT_TIMEOUT);
